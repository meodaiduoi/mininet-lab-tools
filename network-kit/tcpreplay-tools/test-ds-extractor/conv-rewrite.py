...
hosts = ["h1","h3", "h4", "h5", "h8", "h18", "h19"]  
servers = [ "h11", "h12", "h14", "h16", "h17", "h20"]
pairs = []
...
for host in hosts:
    for server in servers:
        ...
        ip_2 = f'10.0.0.{server[1:]}'
        mac_1 = f'00:00:00:00:00:{host[1:]}'
        mac_2 = f'00:00:00:00:00:{server[1:]}'
        pair = {"name": name, "new_ip_1": ip_1, "new_mac_1": mac_2, "new_ip_2": ip_2, "new_mac_2": mac_2}
        pairs.append(pair)
