...
if __name__ == '__main__':
    try:
        ...
        # Create logger
        file_handler = logging.FileHandler(filename=os.path.join(pcapstore_path, f'Tiki_{time.time_ns()}.log'))
        ...
        while True:
            ...
            tiki = TikiLoader(disable_cache=True, disable_http3=True)
            ...
            for no_of_page in range(random.randint(min_page, max_page)):
                ...
                # Interact with tiki
                tiki.load(url)
                tiki.scroll_slowly_to_bottom(random.randint(400,650),
